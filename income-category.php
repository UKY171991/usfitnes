				        ...
				        while ($row = mysqli_fetch_assoc($result)) {
				            echo "<tr>
				                    ...
				                    <td class='text-center'>
				                        ...
				                        <a href='delete-category.php?id={$row['id']}' class='badge badge-sm bg-gradient-danger' onclick='return confirm(\"Are you sure you want to delete this category?\")'><i class='fa fa-trash'></i>Delete</a>
				                    </td>
				                  </tr>";
				            $count++;
				        }
