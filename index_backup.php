...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light navbar-custom">
    ...
    * {
    ...
    /* Override AdminLTE styles that might hide navbar links */
    .navbar-nav .nav-link {
      color: var(--primary-dark) !important;
    ...
    /* Ensure navbar items are visible and properly styled */
    .navbar-collapse {
    ...
    /* Final navbar overrides to ensure visibility - HIGH SPECIFICITY */
    body .navbar.navbar-expand-lg .navbar-nav {
      display: flex !important;
      visibility: visible !important;
    }

    body .navbar.navbar-expand-lg .navbar-nav .nav-item {
      display: block !important;
    }

    body .navbar.navbar-expand-lg .navbar-nav .nav-link {
      display: flex !important;
