...
<head>
  ...
  <title>Add Income Sub-Category</title>
...
<body class="g-sidenav-show bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
    ...
    <div class="container-fluid py-4">
      ...
      <div class="row">
        <div class="col-12">
          <h4 class="text-dark">Add Income Sub-Category</h4>
        </div>
      </div>
          ...
          <div class="card">
            ...
            <div class="card-body px-3">
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  <?php
                  $query = "SELECT sub.id, cat.category_name, sub.subcategory_name FROM income_subcategories sub
                            INNER JOIN income_categories cat ON sub.category_id = cat.id ORDER BY sub.id DESC";
                  $result = mysqli_query($conn, $query);
                  $count = 1;
                  while ($row = mysqli_fetch_assoc($result)) {
                    echo "<tr>
