                ...
                <div class="col-md-6">
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      <button class="btn btn-primary" type="button" onclick="searchPatients()">
                        <i class="fas fa-search"></i>
                      </button>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            <button type="button" class="btn btn-tool" onclick="refreshPatientsTable()" title="Refresh">
              <i class="fas fa-sync-alt"></i>
            </button>
            <button type="button" class="btn btn-tool" onclick="exportPatients()" title="Export">
...
<!-- /.content-wrapper --><!-- Add Patient Modal -->
